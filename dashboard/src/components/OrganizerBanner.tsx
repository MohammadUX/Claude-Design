  ...
  return (
    <div className="relative h-[260px] w-full overflow-hidden rounded-[20.8px] border border-white bg-black">
      <div className="absolute inset-0 grid grid-cols-[1fr_1.4fr_1fr_1fr]">
        ...
        <div className="flex flex-col justify-start bg-[#4f46e5] p-8">
          <span className="text-5xl leading-none font-semibold tracking-tight text-white/95">We run the</span>
          <span className="text-5xl leading-none font-semibold tracking-tight text-white/95">SEO world.</span>
        </div>
        <div className="bg-[linear-gradient(180deg,#e5e7eb,#9ca3af)]" />
        <div className="flex flex-col justify-start bg-[#312e81] p-6">
          <span className="text-2xl leading-tight font-medium text-white/90">The top talent in the industry.</span>
        </div>
      </div>
